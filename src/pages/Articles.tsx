...
import { Calendar, User, Clock, Bookmark, Share, Eye } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="md:ml-64 min-h-screen">
        <div className="pt-16 md:pt-8 px-4 md:px-8 py-6 max-w-7xl mx-auto">
          <h1 className="text-2xl font-bold mb-2">Learning Articles</h1>
          <p className="text-muted-foreground mb-6">Insights and tutorials to enhance your knowledge</p>
          ...
          {filteredArticles.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground">
                No articles available for the selected topic. Please select a different topic.
              </p>
            </div>
          )}
        </div>
